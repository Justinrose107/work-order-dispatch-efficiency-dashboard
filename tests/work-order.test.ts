...
test('classifies any row with departure before dispatch as backfilled', () => {
  const [afterCreated, beforeCreated, arrivalAfterDispatch, missingArrival] = buildWorkOrderRecords([
    {
